...
Set working directory, read data, recalcuate one variable (from milliseconds to seconds), and set seed (I use the year the analysis was conducted, i.e. 2017).
```{r, warning=FALSE}
...
# set seed (defaults to Mersenne-Twister)
seed = 2017
```
...
Table 1 in the article consists of an overview of numerical variables. Using FlexTable, a Word document with the table is created.
```{r}
