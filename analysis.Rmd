...
ggsave(filename = "hidden/figures/riplot.tiff",
       plot = riplot,
       height = 8,
       width = 20,
       dpi = 300,
...
write(vifs, file = "hidden/results/vifs.txt")
...
```{r}
time <- proc.time() - ptm
write(capture.output(paste("analysis took", round(time[3]/60, 0), "minute(s)")), file = "log/timer.txt")
```
